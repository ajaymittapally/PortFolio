    ...
    return (
        <section id="about" className="min-h-screen py-20 bg-gradient-to-b from-[#0A1119] via-[#111827] to-[#0A1119]">
            ...
            <a href={resume} download='resume'>
                 <button  
                 className="mt-5 bg-blue-500 text-white py-3 px-6 rounded font-medium transition relative overflow-hidden hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59,130,246,0.4)] sm:mt-3">
                            Resume <span className="text-gray-800 text-[8px] ml-2 w-1.5 "><DownloadIcon/></span>
                </button>
            </a>
            </div>
        </section>
